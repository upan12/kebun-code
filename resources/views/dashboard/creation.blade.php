                                                        ...
                                                        <div class="modal-dialog modal-dialog-centered modal-lg"
                                                            ...
                                                            <div class="modal-content">
                                                                ...
                                                                <form action="/creation/check/{{ $creation->id }}"
                                                                    id="verifiedCreation_{{ $creation->id }}" method="POST"
                                                                    ...
                                                                    <div class="modal-body">
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text"
                                                                                ...
                                                                                id="source_code" placeholder="Source Code"
                                        ...
                                        <table class="table table-hover" id="table-disable" style="min-height: 210px">
                                            ...
                                            <tbody class="table-border-bottom-0">
                                                @foreach ($creation3 as $creation)
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            {{-- @error('description')
                                                                                ...
                                                                                <input id="description" type="hidden"
                                                                                    name="description"
                                                                                    value="{{ old('description', $creation->description) }}">
                                                    ...
                                                    {{-- Modal detail --}}
                                                    <div class="modal fade"
                                                        id="detailModalDisableCenter{{ $creation->id }}" tabindex="-1"
                                                        aria-hidden="true">
                                                        <div class="modal-dialog modal-dialog-centered modal-lg"
                                                            role="document">
                                                            <div class="modal-content">
