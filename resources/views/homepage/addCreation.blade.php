                            ...
                            <form class="row" method="post" action="/create/creation">
                                ...
                                <div class="form-group col-md-6">
                                  ...
                                  <input type="text" name="creator" class="form-control" placeholder="Creator"
                                      required="required" data-error="Creator is required.">
                                  <div class="help-block with-errors"></div>
                              </div>
                                <div class="form-group col-md-6">
                                    <label class="font-w-6">Technology</label>
                                    <input type="text" name="technology" class="form-control" placeholder="technology"
                                        required="required" data-error="Technology is required.">
                                    <div class="help-block with-errors"></div>
                                </div>
                                <div class="form-group col-md-6">
                                    <label class="font-w-6">Category</label>
                ...
                <div class="row mt-8">
                    <div class="col-12 col-lg-6 mb-6 mb-lg-0">
                        <div>
                            ...
                            <p class="font-w-6">We help companies develop powerful corporate social responsibility,
                                ...
                                <div class="col-md-6">
                                    ...
                                    <ul class="contact-info list-unstyled">
                                        <li class="mb-4 text-dark">
                                            <i class="text-primary fs-4 align-middle bi bi-geo-alt me-2"></i> 423B, Road
                                            Wordwide Country, USA
                                        </li>
                                        <li class="mb-4">
