                                ...
                                <div class="row">
                                    <div class="form-group col-md-12">
                                        ...
                                        <div class="d-flex align-items-start gap-4">
                                            <img src="/images/team/01.jpg" alt="user-avatar" class="d-block rounded"
                                            ...
                                            <div class="button-wrapper">
                                                ...
                                                <p class="text-muted my-0 is-invalid">Allowed JPG, GIF or PNG. Max size of
                                                    800K and Can be empty</p>
                                                @error('image')
                                                    <div id="" class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
